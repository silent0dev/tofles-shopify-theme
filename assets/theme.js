...
if($('[data-customtabsdelay]').length){
  ...
  /// GRODAS OTW-19 Tofles - begin
	document.addEventListener("DOMContentLoaded", evt => {
      ...
      console.log("WINDOW SHOPIFY", window.Shopify.country);
      console.log("WINDOW SHOPIFY", window.Shopify.locale);

      let buttons = document.querySelectorAll(".btn-link");
      let redirectButton = Array.from(buttons).filter(button => button.getAttribute("data-redirect") != null)[0];
      
      console.log("buttons", buttons);
      console.log("redirectButton", redirectButton);
      
      if (redirectButton != null) {
        redirectButton.addEventListener("click", evt => {
          evt.preventDefault();
      ...
      //////// new code
      //////// 02.11
      console.log("____________________ Fetch locale");
      let worldRegions = [{"code":"de-at","currency":"EUR","id":1,"title":"Austria","world_region":"eu"},{"code":"nl-be","currency":"EUR","id":2,"title":"Belgium","world_region":"eu"},{"code":"fr-be","currency":"EUR","id":3,"title":"Belgium","world_region":"eu"},{"code":"de","currency":"EUR","id":4,"title":"Belgium","world_region":"eu"},{"code":"bg","currency":"EUR","id":5,"title":"Bulgaria","world_region":"eu"},{"code":"hr","currency":"EUR","id":6,"title":"Croatia","world_region":"eu"},{"code":"cz","currency":"EUR","id":7,"title":"Czech","world_region":"eu"},{"code":"et","currency":"EUR","id":12,"title":"Estonia","world_region":"eu"},{"code":"fi","currency":"EUR","id":13,"title":"Finland","world_region":"eu"},{"code":"sv-fi","currency":"EUR","id":14,"title":"Finland","world_region":"eu"},{"code":"fr-fr","currency":"EUR","id":18,"title":"France","world_region":"eu"},{"code":"fr","currency":"EUR","id":19,"title":"France","world_region":"eu"},{"code":"de-de","currency":"EUR","id":20,"title":"Germany","world_region":"eu"},{"code":"de","currency":"EUR","id":23,"title":"Germany","world_region":"eu"},{"code":"el","currency":"EUR","id":24,"title":"Greece","world_region":"eu"},{"code":"hu","currency":"EUR","id":25,"title":"Hungary","world_region":"eu"},{"code":"ga","currency":"EUR","id":26,"title":"Ireland","world_region":"eu"},{"code":"en-ie","currency":"EUR","id":27,"title":"Ireland","world_region":"eu"},{"code":"it","currency":"EUR","id":28,"title":"Italy","world_region":"eu"},{"code":"lv","currency":"EUR","id":29,"title":"Latvia","world_region":"eu"},{"code":"lt","currency":"EUR","id":30,"title":"Lithuania","world_region":"eu"},{"code":"lb","currency":"EUR","id":31,"title":"Luxembourg","world_region":"eu"},{"code":"fr-lu","currency":"EUR","id":32,"title":"Luxembourg","world_region":"eu"},{"code":"de-lu","currency":"EUR","id":33,"title":"Luxembourg","world_region":"eu"},{"code":"mt","currency":"EUR","id":34,"title":"Malta","world_region":"eu"},{"code":"fy","currency":"EUR","id":35,"title":"Netherlands","world_region":"eu"},{"code":"nl","currency":"EUR","id":36,"title":"Netherlands","world_region":"eu"},{"code":"pl","currency":"EUR","id":37,"title":"Poland","world_region":"eu"},{"code":"pt","currency":"EUR","id":38,"title":"Portugal","world_region":"eu"},{"code":"ro-ro","currency":"EUR","id":39,"title":"Romania","world_region":"eu"},{"code":"ro","currency":"EUR","id":40,"title":"Romania","world_region":"eu"},{"code":"sk","currency":"EUR","id":41,"title":"Slovakia","world_region":"eu"},{"code":"sl","currency":"EUR","id":42,"title":"Slovenia","world_region":"eu"},{"code":"es-es","currency":"EUR","id":43,"title":"Spain","world_region":"eu"},{"code":"es","currency":"EUR","id":44,"title":"Spain","world_region":"eu"},{"code":"sv-se","currency":"EUR","id":47,"title":"Sweden","world_region":"eu"},{"code":"sv","currency":"EUR","id":48,"title":"Sweden","world_region":"eu"},{"code":"en-us","currency":"USD","id":49,"title":"United States","world_region":"us"},{"code":"en","currency":"USD","id":50,"title":"United States","world_region":"us"},{"code":"en-gb","currency":"GBP","id":51,"title":"England","world_region":"uk"},{"code":"sco","currency":"GBP","id":52,"title":"Scotland","world_region":"uk"},{"code":"cy","currency":"GBP","id":54,"title":"Wales ","world_region":"uk"},{"code":"en-ca","currency":"CAD","id":55,"title":"Canada","world_region":"ca"},{"code":"fr-ca","currency":"CAD","id":56,"title":"Canada","world_region":"ca"}];
      let visitorLanguage = navigator.language || navigator.userLanguage || "en-us";
      let visitorCountry = "US";
      let visitorRegion = "us";

      console.log("navigator.language", navigator.language);
      console.log("navigator.userLanguage", navigator.userLanguage);
      console.log("visitorLanguage", visitorLanguage)

      fetch("/browsing_context_suggestions.json")
      .then(response => response.json())
      .then(data => {
        console.log("visitorCountry", data);
        console.log("____________________ Fetch locale".split("").reverse().join(""));
      })
      .catch(error => {
        visitorCountry = "US";
        console.log("error!!!!!!!!!!!!!!!!!!");
      ...
      console.log("before visitor region", visitorRegion);
      visitorRegion = worldRegions.find(item => item.code === visitorLanguage.toLowerCase());
      if (visitorRegion == undefined)
        visitorRegion = { code: "en-us", currency: "USD", id: 49, title: "United States", world_region: "us" };
      
      console.log("after visitor region", visitorRegion);
      window.visitorRegion = visitorRegion;
      window.visitorCountry = visitorCountry;
      
      
      
      let converterClickInterval = setInterval(function () {
        if (typeof DoublyGlobalCurrency !== typeof undefined) {
          clearInterval(converterClickInterval);
          
          let converterContainer = document.querySelector(".doubly-float");
          let converterSelect = document.querySelector(".doubly-float > .currency-switcher > ul");
          console.log("interval");
          console.log(converterContainer);
          console.log(converterSelect);
          if (converterContainer) {
            Array.from(converterSelect.children).forEach(element => {
              console.log("required currency", visitorRegion.currency);
              console.log("country", visitorRegion.code, visitorRegion.world_region);
              if (element.getAttribute("data-value") !== visitorRegion.currency) {
                console.log("skip", element.getAttribute("data-value"));
              }
              else {
                console.log("CATCH!");
                console.log(element);
...
//       setTimeout(function () { clearInterval(converterClickInterval); console.log("clear interval"); }, 30000);
...
var x = document.getElementsByClassName("faq_question");
var y = document.getElementsByClassName("faq_answer");
var z = document.getElementsByClassName("faq_sign1");
var k = document.getElementsByClassName("faq_sign2");


x[0].onclick = function(){
  y[0].style.display = "block";
  z[0].style.display = "none";
  k[0].style.display = "inline-block";
...
x[1].onclick = function(){
  ...
  k[1].style.display = "inline-block";
...
x[2].onclick = function(){
  ...
  k[2].style.display = "inline-block";
...
x[3].onclick = function(){
  ...
  k[3].style.display = "inline-block";
...
x[4].onclick = function(){
  ...
  k[4].style.display = "inline-block";
...
x[5].onclick = function(){
  ...
  k[5].style.display = "inline-block";
...
x[6].onclick = function(){
  ...
  k[6].style.display = "inline-block";
...
x[7].onclick = function(){
  ...
  k[7].style.display = "inline-block";
...
x[8].onclick = function(){
  ...
  k[8].style.display = "inline-block";
...
x[9].onclick = function(){
  ...
  k[9].style.display = "inline-block";
